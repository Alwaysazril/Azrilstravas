...
const musikRoutes   = require('./routes/musik');
...
app.use('/api/musik',     musikRoutes);    // no auth — streaming musik YouTube
app.use('/api/anime',     animeRoutes);    // no auth — streaming anime & drama
